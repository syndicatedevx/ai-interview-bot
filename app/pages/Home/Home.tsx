...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen">
      <button className="absolute top-8 right-8 z-20 py-2 px-4 rounded-lg bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-medium shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 transition-all duration-300 hover:translate-y-[-2px] cursor-pointer"
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="relative backdrop-blur-md bg-white/5 rounded-xl p-6 border border-white/20 transition-all duration-300 hover:shadow-[0_0_15px_rgba(96,165,250,0.3)] hover:border-blue-300/40">
            ...
            <div className="border-2 border-dashed border-blue-300/30 rounded-lg p-8 flex flex-col items-center justify-center min-h-[300px] transition-all hover:border-blue-300/50 group cursor-pointer">
              <div className="w-20 h-20 bg-white/10 rounded-full flex items-center justify-center mb-4 transition-all group-hover:scale-110 group-hover:shadow-[0_0_15px_rgba(96,165,250,0.4)]">
                <span className="material-symbols-outlined text-4xl text-blue-300"></span>
              </div>
              ...
              <button className="py-2 px-4 rounded-lg bg-blue-500/20 border border-blue-400/30 text-blue-100 font-medium transition-all hover:bg-blue-500/30">
                Browse Files
              </button>
            </div>
          </div>
          <div className="relative backdrop-blur-md bg-white/5 rounded-xl p-6 border border-white/20 transition-all duration-300 hover:shadow-[0_0_15px_rgba(96,165,250,0.3)] hover:border-blue-300/40">
            ...
            <div className="mt-4 flex justify-end">
              <button className="py-2 px-4 rounded-lg bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-medium shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 transition-all duration-300 hover:translate-y-[-2px] cursor-pointer">
                Confirm & Continue
              </button>
            </div>
          </div>
